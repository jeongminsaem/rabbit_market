...
<h3 style="padding:10px 0 60px 0; font-family:'GyeonggiBatang';">■ 커뮤니티 </h3>
	<!-- SEARCH  -->	
<div class="form-group" style="user-select: auto;">
	<form method="post" action="list.bo" style="float: left;" >
		...
		<div style="float: left;"><a class="btn btn-secondary" onclick='$("form").submit()'>검색</a></div>
	</form>	


	<div style="float: right;">
		<c:if test="${ !empty login_info }">
			<a class="btn btn-secondary btn-sm" style="user-select: auto; margin-bottom: 10px" href='new.bo'>글쓰기</a>
		</c:if>
	</div>
</div>	
 ...
 <!-- 게시판  -->
<table style="user-select: auto; text-align: center; width:100%; margin-top: 10px;">
